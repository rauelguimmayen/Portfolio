...
const projects = [
  {
    ...
    color: '#1A1A35',
    image: '/images/globalcart.jpg',
  },
  {
    title: 'Fitness Tracker Application',
    description: 'Architected an intuitive, full-stack Fitness Tracker Application using the MEVN stack (MongoDB, Express.js, Vue.js, Node.js) with a fully responsive layout for all device sizes.',
    tags: ['MongoDB','Express.js', 'Vue.js','Node.js','GitHub','Render','Vercel'],
  ...
  {
    title: '101 Movies - Movie Application',
    description: 'Developed a responsive, full-stack Movie Catalog Application utilizing the MEVN stack (MongoDB, Express.js, Vue.js, Node.js) featuring full cross-browser compatibility.',
    tags: ['MongoDB','Express.js', 'Vue.js','Node.js','GitHub','Render','Vercel'],
  ...
  },
  {
    ...
    description: 'Architected a full-stack, responsive Blog Application utilizing the MEVN stack (MongoDB, Express.js, Vue.js, Node.js) with cross-browser and cross-device compatibility.',
    tags: ['MongoDB','Express.js', 'Vue.js','Node.js','GitHub','Render','Vercel'],
